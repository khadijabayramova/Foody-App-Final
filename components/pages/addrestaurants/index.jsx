...
export default function AddRestaurants() {
  const { setOpenrestaurants, image, resetform } = useContext(GlobalContext);

  return (
    <section className="flex flex-col gap-20 p-5 absolute top-0 -right-2.5 bg-bgadditional w-[67%] h-[183vh]">
      <div className="flex flex-col gap-4 w-full ">
        <div className="flex flex-col w-full gap-4">
          <p className="text-2xl font-bold">Add Restuarant </p>
      ...
      <div className="flex gap-40">
        <p className="text-lg w-[30%]">Add your Restuarants information</p>
